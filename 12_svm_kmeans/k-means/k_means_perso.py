...
X, y = make_blobs(n_samples=100000, centers=10, n_features=2,random_state=1)
...
class KMeans_perso():
    ...
    def plot_clusters(self,X):
        ...
        plt.scatter(X[:, 0], X[:, 1], c=self.labels, cmap='rainbow', alpha=0.3)
        plt.scatter(self.C[0][:,0] ,self.C[0][:,1],c='black',marker='2')
        plt.xlabel('X1')
        plt.ylabel('X2')
